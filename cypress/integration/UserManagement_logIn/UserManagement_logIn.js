...
const dataJson = require('../../fixtures/UserManagement_logIn.json')
...
describe('post UserManagement logIn request', () => {

    it.only('UserManagement Login test', () => {
        

        cy.fixture('UserManagement_logIn.json').then((payload) =>{            
