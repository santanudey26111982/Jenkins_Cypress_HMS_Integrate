...
const dataJson = require('../../fixtures/SearchProvider.json')
...
describe('post search provider request', () => {

    it.only('Search Provider test', () => {
        

        cy.fixture('SearchProvider.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/searchProvider',
                headers: {
