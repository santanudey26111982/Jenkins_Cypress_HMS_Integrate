...
const dataJson = require('../../fixtures/add_provider.json')
...
describe('post add provider request', () => {

    it.only('Add Provider test', () => {
        

        cy.fixture('add_provider.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/provider',
                headers: {
...
   
                    ...
                    expect(res.body.entityData.providerFirstName).to.eq('Alex');
