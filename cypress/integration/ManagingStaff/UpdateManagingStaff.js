...
const dataJson = require('../../fixtures/UpdateManagingStaff.json')
...
describe('post user request', () => {
    ...
    it.only('Update Managingstaff test', () => {
        

        cy.fixture('UpdateManagingStaff.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/updateManagingStaff',
                headers: {
                ...
                body: {
                        ...
                        "metrics1": payload.metrics1,
                        "metrics2": payload.metrics2,
                        "providers": [
                          {
                            "id": payload.id,
