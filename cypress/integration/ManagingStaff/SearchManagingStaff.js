...
const dataJson = require('../../fixtures/SearchManagingStaff.json')
...
describe('post user request', () => {
    ...
    it.only('Search managingstaff test', () => {
        

        cy.fixture('SearchManagingStaff.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/searchManagingStaff',
                headers: {
