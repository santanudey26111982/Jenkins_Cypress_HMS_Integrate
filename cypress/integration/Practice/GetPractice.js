...
const dataJson = require('../../fixtures/GetPractice.json')
...
describe('post practice request', () => {

    it.only('Get Practice test', () => {
        

        cy.fixture('GetPractice.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/getPractice',
                headers: {
