...
const dataJson = require('../../fixtures/​UserManagement​_forgotPassword.json')
...
describe('post ​UserManagement​ forgot password request', () => {

    it.only('​UserManagement​ ForgotPassword test', () => {
        

        cy.fixture('​UserManagement​_forgotPassword.json').then((payload) =>{            
