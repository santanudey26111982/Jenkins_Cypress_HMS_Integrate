...
const dataJson = require('../../fixtures/Add_practice.json')
...
describe('post add practice request', () => {

    it.only('Add practice test', () => {
        

        cy.fixture('Add_practice.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/practice',
                ...
                body: {
                    ...
                    "state": payload.state,
                    "zip": payload.zip,
                    "adminPointOfContact": payload.adminPointOfContact,
                    "directPhoneNumber": payload.directPhoneNumber,
...
   
                    ...
                    expect(res.body.entityData.clinicName).to.eq('ABCD');
