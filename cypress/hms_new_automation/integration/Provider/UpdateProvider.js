...
const dataJson = require('../../fixtures/UpdateProvider.json')
...
describe('post update provider request', () => {

    it.only('Update Provider test', () => {
        

        cy.fixture('UpdateProvider.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/updateProvider',
                headers: {
                ...
                body: {
                        ...
                        "clinicalPointOfContact": payload.clinicalPointOfContact,
                        "staffDirectPhoneNo": payload.staffDirectPhoneNo,
                        "staffDirectEmail": payload.staffDirectEmail,
                        "managingStaffs": [
                            {
                              "id": payload.id,
...
   
                    ...
                    //expect(res.body.entityData.providerFirstName).to.eq('System');
