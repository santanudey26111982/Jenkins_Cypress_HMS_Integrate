...
const dataJson = require('../../fixtures/ProviderAutoSuggestion.json')
...
describe('Post ProviderAutoSuggestion request', () => {

    it.only('ProviderAutoSuggestion test', () => {
        

        cy.fixture('ProviderAutoSuggestion.json').then((payload) =>{            
           
            cy.request({
                method: 'POST',
                url: '/UserManagement/providerAutoSuggestion',
                headers: {
...
   
                    ...
                    //expect(res.body.entityData.firstName).to.eq('David');
