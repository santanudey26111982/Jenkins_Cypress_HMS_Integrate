...
const dataJson = require('../../fixtures/ProviderProfile.json')
...
describe('Get Provider Profile request', () => {

    it.only('Get Provider Profile test', () => {
        

        cy.fixture('ProviderProfile.json').then((payload) =>{            
           
            cy.request({
                method: 'GET',
                url: '/UserManagement/providerProfile?ProviderId=c242d370-e6be-4d5c-ac5d-ead8872f6700',
                headers: {
