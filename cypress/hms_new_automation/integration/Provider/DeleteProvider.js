...
const dataJson = require('../../fixtures/DeleteProvider.json')
...
describe('delete provider request', () => {

    it.only('Delete Provider test', () => {
        

        cy.fixture('DeleteProvider.json').then((payload) =>{            
           
            cy.request({
                method: 'DELETE',
                url: 'http://173.248.158.152/HMS.Testing/api/UserManagement/deleteProvider',
                headers: {
